...
from ltl_tools.ltl2ba import run_ltl2ba
from ltl_tools.promela import parse as parse_ltl, find_states, find_symbols
...
def DuoBA_from_ltls(hard_spec, soft_spec):
    ...
    for f_duonode in list(DuoBA.nodes()):
        for t_duonode in list(DuoBA.nodes()):
